...
!(function (t, e) {
  ...
  class d {
    constructor(t) {
      var e;
      (this.message =
        null !== (e = p[t.type](t.context)) && void 0 !== e
          ? e
          : 'Unexpected error'),
    ...
    static alreadyDisposed() {
      return new d({ type: 'alreadydisposed' });
    }
    static notBindable() {
      return new d({ type: 'notbindable' });
    }
    static propertyNotFound(t) {
      return new d({ type: 'propertynotfound', context: { name: t } });
    }
    static shouldNeverHappen() {
      return new d({ type: 'shouldneverhappen' });
    }
  }
  class c {
    constructor(t, e, n) {
    ...
    writeProperty(t, e) {
      const n = this.read();
      if (!c.isBindable(n)) throw d.notBindable();
      if (!(t in n)) throw d.propertyNotFound(t);
      n[t] = e;
    }
  }
  class h extends e {
  ...
  function _(t, e) {
    var n, i;
    t.emitter.on('change', ((n = b), (i = e), (t) => i(n(t)))), e(t.rawValue);
  }
  function g(t, e, n) {
    _(t.value(e), n);
  }
  ...
  class k {
    constructor(t) {
      (this.emitter = new u()), (this.value_ = t);
    }
    get rawValue() {
      return this.value_;
    }
  ...
  function E(t, e) {
    ...
    return n || i ? new P(t, e) : new k(t);
  }
  class V {
    constructor(t) {
      (this.emitter = new u()), (this.valMap_ = t);
  ...
  const S = { optional: M(!0), required: M(!1) };
  function A(t, e) {
    const n = S.required.object(e)(t);
    return n.succeeded ? n.value : void 0;
  }
  const D = m(''),
    j = { veryfirst: 'vfst', first: 'fst', last: 'lst', verylast: 'vlst' };
  class R {
    constructor(t) {
      (this.parent_ = null),
        (this.blade = t.blade),
      ...
      this.blade.value('positions').emitter.on('change', () => {
        ['veryfirst', 'first', 'last', 'verylast'].forEach((t) => {
          e.classList.remove(D(void 0, j[t]));
        }),
          this.blade.get('positions').forEach((t) => {
            e.classList.add(D(void 0, j[t]));
          });
      }),
  ...
  function T(t, e) {
    const n = t.createElementNS(O, 'svg');
    return (n.innerHTML = U[e]), n;
  }
  function B(t, e, n) {
    ...
    constructor(t, e) {
      ...
      super(
        Object.assign(Object.assign({}, e), {
          view: new q(t, { props: e.props, viewProps: n }),
          viewProps: n,
        })
      ),
        (this.props = e.props),
  ...
  const Y = {
    ...
    controller: (t) =>
      new G(t.document, {
        ...
        valueController: new y(t.document, {
          props: V.fromObject({ title: t.params.title }),
          viewProps: t.viewProps,
        }),
      }),
    api: (t) =>
      t.controller instanceof G && t.controller.valueController instanceof y
        ? new h(t.controller)
        : null,
  };
  class X extends R {
  ...
  function Q() {
    return new V({ positions: E([], { equals: l }) });
  }
  class J extends V {
    constructor(t) {
      super(t);
  ...
  class et {
    ...
    add(t, e) {
      if (this.includes(t)) throw d.shouldNeverHappen();
  ...
  function at(t, e) {
    ...
    if (!n) throw d.shouldNeverHappen();
    return n;
  }
  function lt(t, e, n) {
    if (!c.isBindable(t)) throw d.notBindable();
    return new c(t, e, n);
  }
  class pt extends e {
    constructor(t, e) {
    ...
    get children() {
      return this.controller_.rack.children.map((t) => at(this.apiSet_, t));
    }
    addInput(t, e, n) {
      const i = null != n ? n : {},
        s = this.controller_.view.element.ownerDocument,
        o = this.pool_.createInput(s, lt(t, e, i.presetKey), i),
        r = new nt(o);
    ...
    addMonitor(t, e, n) {
      const i = null != n ? n : {},
        s = this.controller_.view.element.ownerDocument,
        o = this.pool_.createMonitor(s, lt(t, e), i),
        r = new st(o);
      return this.add(r, i.index);
    }
    addFolder(t) {
    ...
    onRackRemove_(t) {
      if (t.isRoot) {
        const e = at(this.apiSet_, t.bladeController);
    ...
    onRackMonitorUpdate_(t) {
      if (!(t.bladeController instanceof ot)) throw d.shouldNeverHappen();
      const e = at(this.apiSet_, t.bladeController),
  ...
  class mt {
    ...
    onChildInputChange_(t) {
      const e = (function (t, e) {
        for (let n = 0; n < t.length; n++) {
          const i = t[n];
          if (i instanceof it && i.binding === e) return i;
        }
        return null;
      })(this.find(it), t.sender);
      if (!e) throw d.alreadyDisposed();
    ...
    onChildMonitorUpdate_(t) {
      const e = (function (t, e) {
        for (let n = 0; n < t.length; n++) {
          const i = t[n];
          if (i instanceof ot && i.binding === e) return i;
        }
        return null;
      })(this.find(ot), t.sender);
      if (!e) throw d.alreadyDisposed();
    ...
    onChildValueChange_(t) {
      const e = (function (t, e) {
        for (let n = 0; n < t.length; n++) {
          const i = t[n];
          if (i instanceof X && i.value === e) return i;
        }
        return null;
      })(this.find(X), t.sender);
      if (!e) throw d.alreadyDisposed();
      this.emitter.emit('inputchange', {
        bladeController: e,
        options: t.options,
  ...
  class bt extends R {
    constructor(t, e) {
      super(
        Object.assign(Object.assign({}, e), {
          view: new ht(t, { viewName: 'brk', viewProps: e.viewProps }),
        })
      ),
        (this.onRackAdd_ = this.onRackAdd_.bind(this)),
        (this.onRackRemove_ = this.onRackRemove_.bind(this));
      const n = new mt(e.root ? void 0 : e.blade);
      n.emitter.on('add', this.onRackAdd_),
        n.emitter.on('remove', this.onRackRemove_),
        (this.rack = n),
        this.viewProps.handleDispose(() => {
    ...
    onRackRemove_(t) {
      t.isRoot && F(t.bladeController.view.element);
    }
  }
  const _t = m('cnt');
  class gt {
    constructor(t, e) {
      ...
      (this.className_ = m(
        ...
        (this.element = t.createElement('div')),
        this.element.classList.add(this.className_(), _t()),
        e.viewProps.bindClassModifiers(this.element),
        ...
        g(
          this.foldable_,
          'completed',
          f(this.element, this.className_(void 0, 'cpl'))
        );
      ...
      r.classList.add(this.className_('c')),
  ...
  class ft extends ct {
    constructor(t, e) {
      var n;
      const i = J.create(null === (n = e.expanded) || void 0 === n || n),
        s = new bt(t, { blade: e.blade, root: e.root, viewProps: e.viewProps });
      super(
        Object.assign(Object.assign({}, e), {
          rackController: s,
          view: new gt(t, {
        ...
        (this.props = e.props),
        (this.foldable = i),
        Z(this.foldable, this.view.containerElement),
  ...
  const wt = {
    ...
    api: (t) =>
      t.controller instanceof ft ? new dt(t.controller, t.pool) : null,
  };
  class xt extends X {
    constructor(t, e) {
      const n = e.valueController.viewProps;
  ...
  class kt extends R {
    constructor(t, e) {
      super(
        Object.assign(Object.assign({}, e), {
          view: new Pt(t, { viewProps: e.viewProps }),
        })
      );
    }
  }
  const Et = {
      ...
      type: 'blade',
      accept(t) {
        const e = A(t, { view: S.required.constant('separator') });
        return e ? { params: e } : null;
      },
      controller: (t) =>
        new kt(t.document, { blade: t.blade, viewProps: t.viewProps }),
      api: (t) => (t.controller instanceof kt ? new Ct(t.controller) : null),
    },
    Vt = m('');
  function Lt(t, e) {
    return f(t, Vt(void 0, e));
  }
  class Mt extends V {
    constructor(t) {
      super(t);
    ...
    bindClassModifiers(t) {
      g(this, 'disabled', Lt(t, 'disabled')),
        g(this, 'hidden', Lt(t, 'hidden'));
    }
    bindDisabled(t) {
      g(this, 'disabled', (e) => {
        t.disabled = e;
    ...
    constructor(t, e) {
      (this.element = t.createElement('div')),
        ...
        g(e.props, 'selected', (t) => {
          t
            ? this.element.classList.add(St(void 0, 'sel'))
            : this.element.classList.remove(St(void 0, 'sel'));
        });
      const n = t.createElement('button');
      n.classList.add(St('b')),
        e.viewProps.bindDisabled(n),
        this.element.appendChild(n),
        (this.buttonElement = n);
      const i = t.createElement('div');
      i.classList.add(St('t')),
        w(e.props.value('title'), i),
        this.buttonElement.appendChild(i),
        (this.titleElement = i);
    }
  ...
  class Dt {
    constructor(t, e) {
      (this.emitter = new u()),
        ...
        (this.props = e.props),
        (this.viewProps = e.viewProps),
        (this.view = new At(t, { props: e.props, viewProps: e.viewProps })),
        this.view.buttonElement.addEventListener('click', this.onClick_);
    }
    onClick_() {
      this.emitter.emit('click', { sender: this });
  ...
  class jt {
    constructor(t, e) {
      (this.onItemClick_ = this.onItemClick_.bind(this)),
        (this.ic_ = new Dt(t, { props: e.itemProps, viewProps: Mt.create() })),
        this.ic_.emitter.on('click', this.onItemClick_),
        (this.cc_ = new bt(t, { blade: Q(), viewProps: Mt.create() })),
        (this.props = e.props),
  ...
  class Ot extends tt {
    ...
    get pages() {
      return this.controller_.pageSet.items.map((t) => {
        ...
        if (!e) throw d.shouldNeverHappen();
        return e;
      });
    }
    addPage(t) {
      ...
      if (!i) throw d.shouldNeverHappen();
      return i;
    }
    removePage(t) {
    ...
    onPageRemove_(t) {
      if (!this.pageApiMap_.get(t.item)) throw d.shouldNeverHappen();
  ...
  class Nt {
    constructor(t, e) {
      (this.element = t.createElement('div')),
        this.element.classList.add(Kt(), _t()),
        e.viewProps.bindClassModifiers(this.element),
        _(e.empty, f(this.element, Kt(void 0, 'nop')));
      const n = t.createElement('div');
  ...
  class Ut extends ct {
    constructor(t, e) {
      const n = new bt(t, { blade: e.blade, viewProps: e.viewProps }),
        i = new It();
      super({
        blade: e.blade,
        rackController: n,
    ...
    onPageRemove_(t) {
      const e = t.item;
      F(e.itemController.view.element),
  ...
  const Tt = {
    ...
    api: (t) =>
      t.controller instanceof Ut ? new Ot(t.controller, t.pool) : null,
  };
  class Bt {
    constructor() {
      (this.disabled = !1), (this.emitter = new u());
    }
    dispose() {}
    tick() {
  ...
  class qt {
    ...
    constrain(t) {
      let e = t;
      return (
        a(this.minValue) || (e = Math.max(e, this.minValue)),
        a(this.maxValue) || (e = Math.min(e, this.maxValue)),
        e
      );
    }
  }
  ...
  class Xt {
    constructor(t, e) {
      ...
      const i = t.createElement('div');
      i.classList.add(Yt('m')),
        i.appendChild(T(t, 'dropdown')),
        this.element.appendChild(i),
  ...
  class Wt {
    constructor(t, e) {
      (this.element = t.createElement('div')),
        ...
        e.viewProps.bindClassModifiers(this.element),
        _(e.shows, f(this.element, Jt(void 0, 'v')));
    }
  }
  class Zt {
    constructor(t, e) {
  ...
  const me = de([
    function (t, e) {
      ...
      const s = he(t, e);
      return n + i + s + ue(t, (e += s.length));
    },
    function (t, e) {
      const n = t.substr(e, 1);
      if (((e += n.length), '.' !== n)) return '';
      const i = he(t, e);
      return (e += i.length), '' === i ? '' : n + i + ue(t, e);
    },
    function (t, e) {
      const n = ve(t, e);
      return (e += n.length), '' === n ? '' : n + ue(t, e);
    },
  ]);
  const be = de([
      function (t, e) {
  ...
  function ge(t, e) {
    ...
    return null !==
      (n = (function (t, e) {
        const n = _e(t, e);
        return (
          (e += n.length), '' === n ? null : { evaluable: new oe(n), cursor: e }
        );
      })(t, e)) && void 0 !== n
      ? n
      : (function (t, e) {
  ...
  function fe(t, e, n) {
    ...
    return i
      ? ((n += i.length), { cursor: (n += ce(e, n).length), operator: i })
      : null;
  }
  const we = [
    ['**'],
      ...
      (function (t, e) {
        return (n, i) => {
          ...
          for (;;) {
            ...
            const r = t(n, i);
            if (!r) return null;
            (i = r.cursor), (o = new ae(s.operator, o, r.evaluable));
          }
    ...
    function t(e, n) {
      ...
      const o = t(e, n);
      return o
        ? { cursor: (n = o.cursor), evaluable: new pe(s, o.evaluable) }
        : null;
    }
  );
  function xe(t, e) {
    return (e += ce(t, e).length), we(t, e);
  }
  function Ce(t) {
    var e;
    const n = (function (t) {
      const e = xe(t, 0);
      return e
        ? e.cursor + ce(t, e.cursor).length !== t.length
          ? null
          : e.evaluable
        : null;
    })(t);
  ...
  function je({ primary: t, secondary: e, forward: n, backward: i }) {
    let s = !1;
    function o(t) {
      s || ((s = !0), t(), (s = !1));
    }
    ...
    onMouseDown_(t) {
      ...
      n.addEventListener('mousemove', this.onDocumentMouseMove_),
        ...
        this.emitter.emit('down', {
          altKey: t.altKey,
          data: this.computePosition_(Ne(t, this.elem_)),
          sender: this,
          shiftKey: t.shiftKey,
        });
    }
  ...
  class ze {
    constructor(t, e) {
      (this.onChange_ = this.onChange_.bind(this)),
        ...
        this.props_.emitter.on('change', this.onChange_),
        (this.element = t.createElement('div')),
        this.element.classList.add(He(), He(void 0, 'num')),
        e.arrayPosition &&
          this.element.classList.add(He(void 0, e.arrayPosition)),
        e.viewProps.bindClassModifiers(this.element);
      const n = t.createElement('input');
      n.classList.add(He('i')),
        (n.type = 'text'),
        e.viewProps.bindDisabled(n),
        this.element.appendChild(n),
        (this.inputElement = n),
        ...
        this.inputElement.classList.add(He('i'));
      const i = t.createElement('div');
      i.classList.add(He('k')),
        this.element.appendChild(i),
        (this.knobElement = i);
      const s = t.createElementNS(O, 'svg');
      s.classList.add(He('g')), this.knobElement.appendChild(s);
      const o = t.createElementNS(O, 'path');
      o.classList.add(He('gb')), s.appendChild(o), (this.guideBodyElem_ = o);
      const r = t.createElementNS(O, 'path');
      r.classList.add(He('gh')), s.appendChild(r), (this.guideHeadElem_ = r);
    ...
    onDraggingChange_(t) {
      if (null === t.rawValue)
        return void this.element.classList.remove(He(void 0, 'drg'));
  ...
  class qe {
    constructor(t, e) {
      ...
      const i = new Ue(this.view.knobElement);
    ...
    onInputKeyDown_(t) {
      const e = Re(this.baseStep_, Oe(t));
      0 !== e &&
  ...
  class Ye {
    constructor(t, e) {
      (this.onChange_ = this.onChange_.bind(this)),
        ...
        e.viewProps.bindClassModifiers(this.element);
      const n = t.createElement('div');
      n.classList.add(Ge('t')),
        e.viewProps.bindTabIndex(n),
        this.element.appendChild(n),
        (this.trackElement = n);
      const i = t.createElement('div');
      i.classList.add(Ge('k')),
  ...
  class Xe {
    ...
    onKeyDown_(t) {
      const e = Re(this.baseStep_, Ie(t));
      0 !== e &&
  ...
  class Je {
    constructor(t, e) {
      (this.element = t.createElement('div')), this.element.classList.add(Qe());
      const n = t.createElement('div');
      n.classList.add(Qe('s')),
        (this.sliderView_ = e.sliderView),
        n.appendChild(this.sliderView_.element),
        this.element.appendChild(n);
      const i = t.createElement('div');
      i.classList.add(Qe('t')),
  ...
  function on(t) {
    return a(t) ? null : new zt(sn(t));
  }
  function rn(t) {
    const e = t ? Ht(t, zt) : null;
    return e ? e.options : null;
  }
  function an(t, e) {
    const n = t && Ht(t, Gt);
    return n ? Be(n.step) : Math.max(Be(e), 2);
  }
  function ln(t) {
    const e = (function (t) {
      const e = t ? Ht(t, Gt) : null;
  ...
  class cn {
    constructor(t, e) {
      ...
      n.classList.add(dn('l')), this.element.appendChild(n);
      const i = t.createElement('input');
      i.classList.add(dn('i')),
        (i.type = 'checkbox'),
        n.appendChild(i),
        (this.inputElement = i),
        e.viewProps.bindDisabled(this.inputElement);
      const s = t.createElement('div');
      s.classList.add(dn('w')), n.appendChild(s);
      const o = T(t, 'check');
      s.appendChild(o),
        e.value.emitter.on('change', this.onValueChange_),
        (this.value = e.value),
  ...
  const un = {
      ...
      accept: (t, e) => {
        ...
        const n = A(e, { options: S.optional.custom(tn) });
      ...
      controller: (t) => {
        ...
        return s && Ht(s, zt)
          ? new Qt(n, {
              props: V.fromObject({
                options: null !== (e = rn(s)) && void 0 !== e ? e : [],
              }),
              value: i,
              viewProps: t.viewProps,
            })
          : new hn(n, { value: i, viewProps: t.viewProps });
      },
    },
    vn = m('col');
  class mn {
    constructor(t, e) {
      (this.element = t.createElement('div')),
        ...
        e.foldable.bindExpandedClass(this.element, vn(void 0, 'expanded')),
        g(e.foldable, 'completed', f(this.element, vn(void 0, 'cpl')));
      const n = t.createElement('div');
      n.classList.add(vn('h')), this.element.appendChild(n);
      const i = t.createElement('div');
      i.classList.add(vn('s')), n.appendChild(i), (this.swatchElement = i);
      const s = t.createElement('div');
      if (
        (s.classList.add(vn('t')),
        n.appendChild(s),
        (this.textElement = s),
        'inline' === e.pickerLayout)
      ) {
        const e = t.createElement('div');
        e.classList.add(vn('p')),
  ...
  class yn {
    constructor(t, e, n = 'int') {
      (this.mode = e),
        ...
        (this.comps_ = (function (t, e, n) {
          ...
          const s = wn(e, n);
          return [
            'rgb' === e ? Fe(t[0], 0, s[0]) : $e(t[0], s[0]),
            Fe(t[1], 0, s[1]),
            Fe(t[2], 0, s[2]),
            Fe(null !== (i = t[3]) && void 0 !== i ? i : 1, 0, 1),
          ];
        })(t, e, n));
    }
    static black(t = 'int') {
      return new yn([0, 0, 0], 'rgb', t);
    }
    static fromObject(t, e = 'int') {
      const n = 'a' in t ? [t.r, t.g, t.b, t.a] : [t.r, t.g, t.b];
      return new yn(n, 'rgb', e);
    }
    static toRgbaObject(t, e = 'int') {
      return t.toRgbaObject(e);
    }
    static isRgbColorObject(t) {
      return Cn(t, 'r') && Cn(t, 'g') && Cn(t, 'b');
    }
    static isRgbaColorObject(t) {
      return this.isRgbColorObject(t) && Cn(t, 'a');
    }
    ...
    getComponents(t, e = 'int') {
      return gn(
        (function (t, e, n) {
          const i = xn(t, e.mode, e.type, 'int');
          return xn(fn[e.mode][n.mode](...i), n.mode, 'int', n.type);
        })(
          _n(this.comps_),
  ...
  class kn {
    constructor(t, e) {
      ...
      if (
        ...
        const n = t.createElement('div');
        n.classList.add(Pn('a'));
        const i = t.createElement('div');
        i.classList.add(Pn('ap')),
          i.appendChild(this.alphaViews_.palette.element),
          n.appendChild(i);
        const s = t.createElement('div');
        s.classList.add(Pn('at')),
  ...
  function Vn(t) {
    ...
    return A(t, {
      ...
      color: e.optional.object({
        alpha: e.optional.boolean,
        type: e.optional.custom(En),
      }),
      expanded: e.optional.boolean,
      picker: e.optional.custom(en),
    });
  }
  function Ln(t) {
    return t ? 0.1 : 1;
  ...
  function jn(t) {
    ...
    if (!e) return null;
    const n = [Sn(e[1], 255), Sn(e[2], 255), Sn(e[3], 255)];
    return isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) ? null : n;
  }
  function Rn(t) {
    return (e) => {
      const n = jn(e);
      return n ? new yn(n, 'rgb', t) : null;
    };
  }
  function On(t) {
    const e = t.match(
    ...
    if (!e) return null;
    const n = [Sn(e[1], 255), Sn(e[2], 255), Sn(e[3], 255), Sn(e[4], 1)];
  ...
  function Kn(t) {
    ...
    if (!e) return null;
    const n = [Dn(e[1]), Sn(e[2], 100), Sn(e[3], 100)];
    return isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) ? null : n;
  }
  function Nn(t) {
    return (e) => {
      const n = Kn(e);
      return n ? new yn(n, 'hsl', t) : null;
    };
  }
  function Un(t) {
    const e = t.match(
    ...
    if (!e) return null;
    const n = [Dn(e[1]), Sn(e[2], 100), Sn(e[3], 100), Sn(e[4], 1)];
    return isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) || isNaN(n[3]) ? null : n;
  }
  function Tn(t) {
    return (e) => {
  ...
  function Fn(t) {
    ...
    if (e)
      return [
        ...
        parseInt(e[2] + e[2], 16),
        parseInt(e[3] + e[3], 16),
        Te(parseInt(e[4] + e[4], 16), 0, 255, 0, 1),
      ];
    const n = t.match(
  ...
  const Gn = [
    { parser: Bn, result: { alpha: !1, mode: 'rgb', notation: 'hex' } },
    { parser: Fn, result: { alpha: !0, mode: 'rgb', notation: 'hex' } },
    { parser: jn, result: { alpha: !1, mode: 'rgb', notation: 'func' } },
    { parser: On, result: { alpha: !0, mode: 'rgb', notation: 'func' } },
    { parser: Kn, result: { alpha: !1, mode: 'hsl', notation: 'func' } },
    { parser: Un, result: { alpha: !0, mode: 'hsl', notation: 'func' } },
    { parser: $n, result: { alpha: !1, mode: 'rgb', notation: 'object' } },
    { parser: zn, result: { alpha: !0, mode: 'rgb', notation: 'object' } },
  ];
  function Yn(t, e = 'int') {
    const n = (function (t) {
      return Gn.reduce(
  ...
  const Xn = {
    int: [
      function (t) {
        const e = Bn(t);
        return e ? new yn(e, 'rgb', 'int') : null;
      },
      function (t) {
        const e = Fn(t);
        return e ? new yn(e, 'rgb', 'int') : null;
  ...
  function Jn(t) {
    const e = Fe(Math.floor(t), 0, 255).toString(16);
    return 1 === e.length ? `0${e}` : e;
  }
  function Wn(t, e = '#') {
    return `${e}${_n(t.getComponents('rgb')).map(Jn).join('')}`;
  }
  function Zn(t, e = '#') {
  ...
  class ci {
    ...
    update_() {
      const t = this.value.rawValue,
        ...
        n = new yn([e[0], e[1], e[2], 0], 'rgb'),
        i = new yn([e[0], e[1], e[2], 255], 'rgb'),
        s = ['to right', ni(n), ni(i)];
      (this.colorElem_.style.background = `linear-gradient(${s.join(',')})`),
        (this.previewElem_.style.backgroundColor = ni(t));
      const o = Te(e[3], 0, 1, 0, 100);
  ...
  class hi {
    ...
    handlePointerEvent_(t, e) {
      ...
      this.value.setRawValue(new yn([s, o, r, n], 'hsv'), e);
    }
    onPointerDown_(t) {
      this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
    }
    ...
    onKeyDown_(t) {
      const e = Re(Ln(!0), Ie(t));
      if (0 === e) return;
      const n = this.value.rawValue,
        [i, s, o, r] = n.getComponents('hsv');
      this.value.setRawValue(new yn([i, s, o, r + e], 'hsv'), {
        forceEmit: !1,
        last: !1,
      });
    }
  ...
  class vi {
    constructor(t, e) {
      (this.element = t.createElement('div')), this.element.classList.add(ui());
      const n = t.createElement('div');
      n.classList.add(ui('m')),
        ...
        this.modeElem_.classList.add(ui('ms')),
        n.appendChild(this.modeSelectElement);
      const i = t.createElement('div');
      i.classList.add(ui('mm')),
        i.appendChild(T(t, 'dropdown')),
        n.appendChild(i),
        this.element.appendChild(n);
      const s = t.createElement('div');
      s.classList.add(ui('w')),
        this.element.appendChild(s),
        (this.textsElem_ = s),
  ...
  function bi(t, e, n) {
    return new qe(t, {
      ...
      props: V.fromObject({
        ...
        formatter: ((i = e.colorType), ke('float' === i ? 2 : 0)),
      }),
      value: E(0, { constraint: mi(e.colorMode, e.colorType, n) }),
      viewProps: e.viewProps,
    });
    var i;
  }
        ...
        n.forEach((t, e) => {
          je({
            ...
            backward: (t, n) => {
              ...
              return (
                (s[e] = n.rawValue), new yn(gn(_n(s), s[3]), i, this.colorType_)
              );
            },
          });
        }),
  ...
  class fi {
    constructor(t, e) {
      (this.onValueChange_ = this.onValueChange_.bind(this)),
        ...
        e.viewProps.bindTabIndex(this.element);
      const n = t.createElement('div');
      n.classList.add(gi('c')), this.element.appendChild(n);
      const i = t.createElement('div');
      i.classList.add(gi('m')),
        this.element.appendChild(i),
        (this.markerElem_ = i),
        this.update_();
    }
    update_() {
      ...
      this.markerElem_.style.backgroundColor = ti(new yn([e, 100, 100], 'hsv'));
      const n = Te(e, 0, 360, 0, 100);
  ...
  class wi {
    ...
    handlePointerEvent_(t, e) {
      if (!t.point) return;
      const n = Te(Fe(t.point.x, 0, t.bounds.width), 0, t.bounds.width, 0, 359),
        i = this.value.rawValue,
        [, s, o, r] = i.getComponents('hsv');
      this.value.setRawValue(new yn([n, s, o, r], 'hsv'), e);
    }
    onPointerDown_(t) {
      this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
    }
    ...
    onKeyDown_(t) {
      const e = Re(Ln(!1), Ie(t));
      if (0 === e) return;
      const n = this.value.rawValue,
        [i, s, o, r] = n.getComponents('hsv');
      this.value.setRawValue(new yn([i + e, s, o, r], 'hsv'), {
        forceEmit: !1,
        last: !1,
      });
    }
  ...
  class Ci {
    ...
    update_() {
      ...
      const r = Te(e[1], 0, 100, 0, 100);
      this.markerElem_.style.left = `${r}%`;
      const a = Te(e[2], 0, 100, 100, 0);
  ...
  class yi {
    ...
    handlePointerEvent_(t, e) {
      if (!t.point) return;
      const n = Te(t.point.x, 0, t.bounds.width, 0, 100),
        i = Te(t.point.y, 0, t.bounds.height, 100, 0),
        [s, , , o] = this.value.rawValue.getComponents('hsv');
      this.value.setRawValue(new yn([s, n, i, o], 'hsv'), e);
    }
    onPointerDown_(t) {
      this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
    }
    ...
    onKeyDown_(t) {
      ...
      const [e, n, i, s] = this.value.rawValue.getComponents('hsv'),
        ...
        a = Re(o, Oe(t));
      (0 === r && 0 === a) ||
        this.value.setRawValue(new yn([e, n + r, i + a, s], 'hsv'), {
          forceEmit: !1,
          last: !1,
        });
    }
  ...
  class Pi {
    constructor(t, e) {
      (this.value = e.value),
        (this.viewProps = e.viewProps),
        (this.hPaletteC_ = new wi(t, {
          value: this.value,
          viewProps: this.viewProps,
        })),
        (this.svPaletteC_ = new yi(t, {
          value: this.value,
          viewProps: this.viewProps,
        })),
        (this.alphaIcs_ = e.supportsAlpha
          ? {
              ...
              text: new qe(t, {
                parser: Ce,
                baseStep: 0.1,
                props: V.fromObject({ draggingScale: 0.01, formatter: ke(2) }),
                value: E(0, { constraint: new qt({ min: 0, max: 1 }) }),
                viewProps: this.viewProps,
              }),
            }
          : null),
        this.alphaIcs_ &&
          je({
            ...
            backward: (t, e) => {
              ...
              return (n[3] = e.rawValue), new yn(n, t.rawValue.mode);
            },
          }),
        (this.textC_ = new _i(t, {
  ...
  class Ei {
    constructor(t, e) {
      (this.onValueChange_ = this.onValueChange_.bind(this)),
        ...
        e.viewProps.bindClassModifiers(this.element);
      const n = t.createElement('div');
      n.classList.add(ki('sw')),
        this.element.appendChild(n),
        (this.swatchElem_ = n);
      const i = t.createElement('button');
      i.classList.add(ki('b')),
        e.viewProps.bindDisabled(i),
        this.element.appendChild(i),
        (this.buttonElement = i),
        this.update_();
    ...
    update_() {
      const t = this.value.rawValue;
      this.swatchElem_.style.backgroundColor = Zn(t);
    }
    onValueChange_() {
      this.update_();
    }
  ...
  class Li {
    constructor(t, e) {
      (this.onButtonBlur_ = this.onButtonBlur_.bind(this)),
        ...
        (this.value = e.value),
        (this.viewProps = e.viewProps),
        (this.foldable_ = J.create(e.expanded)),
        (this.swatchC_ = new Vi(t, {
          value: this.value,
          viewProps: this.viewProps,
        }));
      ...
      n.addEventListener('blur', this.onButtonBlur_),
        ...
        (this.popC_ =
          'popup' === e.pickerLayout
            ? new Zt(t, { viewProps: this.viewProps })
            : null);
      const i = new Pi(t, {
        colorType: e.colorType,
        supportsAlpha: e.supportsAlpha,
      ...
      i.view.allFocusableElements.forEach((t) => {
        ...
        this.popC_
          ...
          : this.view.pickerElement &&
            ...
            Z(this.foldable_, this.view.pickerElement));
    }
    get textController() {
      return this.textC_;
    }
    ...
    onPopupChildBlur_(t) {
      ...
      const e = this.popC_.view.element,
        n = H(t);
      (n && e.contains(n)) ||
        (n && n === this.swatchC_.view.buttonElement && !K(e.ownerDocument)) ||
  ...
  function Ai(t) {
    return 'number' != typeof t
      ? yn.black()
      : new yn([((e = t) >> 16) & 255, (e >> 8) & 255, 255 & e], 'rgb');
    var e;
  }
  function Di(t) {
    return 'number' != typeof t
  ...
  function Ii(t) {
    return (e) =>
      (function (t, e) {
        return yn.isColorObject(t) ? yn.fromObject(t, e) : yn.black(e);
      })(e, t);
  }
  function Ki(t, e) {
    return (n) => (t ? ri(n, e) : si(n, e));
  }
  const Ni = {
      id: 'input-color-object',
      type: 'input',
      accept: (t, e) => {
        if (!yn.isColorObject(t)) return null;
        const n = Vn(e);
        return n ? { initialValue: t, params: n } : null;
      },
      binding: {
        reader: (t) => Ii(Mn(t.params)),
        equals: yn.equals,
        writer: (t) => {
          return (
            (i = t.initialValue),
            (e = yn.isRgbaColorObject(i)),
            (n = Mn(t.params)),
            (t, i) => {
              e
                ? (function (t, e, n) {
      ...
      binding: {
        reader: (t) => {
          ...
          return (function (t) {
            const e = Xn[t];
            return (n) => {
              if ('string' != typeof n) return yn.black(t);
              const i = e.reduce((t, e) => t || e(n), null);
              return null != i ? i : yn.black(t);
            };
          })(null !== (e = Mn(t.params)) && void 0 !== e ? e : 'int');
        },
        equals: yn.equals,
        writer: (t) => {
          const e = Yn(t.initialValue, Mn(t.params));
          if (!e) throw d.shouldNeverHappen();
          const n = (function (t) {
            const e = pi(t);
            return e
  ...
  function Hi(t, e) {
    return 'step' in t && !a(t.step) ? new Gt(t.step, e) : null;
  }
  function zi(t) {
    return ('max' in t && !a(t.max)) || ('min' in t && !a(t.min))
      ? new qt({ max: t.max, min: t.min })
      : null;
  }
  function qi(t) {
    const [e, n] = (function (t) {
      const e = t ? Ht(t, qt) : null;
  ...
  const Gi = {
    ...
    binding: {
      ...
      constraint: (t) =>
        (function (t, e) {
          ...
          const s = zi(t);
          s && n.push(s);
          const o = on(t.options);
          return o && n.push(o), new $t(n);
    ...
    controller: (t) => {
      ...
      if (s && Ht(s, qt)) {
        const [e, n] = qi(s);
        return new We(t.document, {
          baseStep: ln(s),
          parser: Ce,
          sliderProps: V.fromObject({ maxValue: n, minValue: e }),
          textProps: V.fromObject({
            draggingScale: pn(s, i.rawValue),
            formatter: o,
          }),
          value: i,
          viewProps: t.viewProps,
      ...
      return new qe(t.document, {
        baseStep: ln(s),
        parser: Ce,
        props: V.fromObject({ draggingScale: pn(s, i.rawValue), formatter: o }),
        value: i,
        viewProps: t.viewProps,
      });
    },
  ...
  class Ji {
    constructor(t, e) {
      (this.element = t.createElement('div')),
        ...
        e.viewProps.bindClassModifiers(this.element),
        _(e.expanded, f(this.element, Qi(void 0, 'expanded')));
      const n = t.createElement('div');
      n.classList.add(Qi('h')), this.element.appendChild(n);
      const i = t.createElement('button');
      i.classList.add(Qi('b')),
        i.appendChild(T(t, 'p2dpad')),
        e.viewProps.bindDisabled(i),
        n.appendChild(i),
        (this.buttonElement = i);
      const s = t.createElement('div');
      if (
        (s.classList.add(Qi('t')),
        n.appendChild(s),
        (this.textElement = s),
        'inline' === e.pickerLayout)
      ) {
        const e = t.createElement('div');
        e.classList.add(Qi('p')),
          this.element.appendChild(e),
          (this.pickerElement = e);
      } else this.pickerElement = null;
    }
  ...
  class Zi {
    constructor(t, e) {
      (this.onFoldableChange_ = this.onFoldableChange_.bind(this)),
        ...
        'popup' === e.layout && this.element.classList.add(Wi(void 0, 'p'));
      const n = t.createElement('div');
      n.classList.add(Wi('p')),
        e.viewProps.bindTabIndex(n),
        this.element.appendChild(n),
        (this.padElement = n);
      const i = t.createElementNS(O, 'svg');
      i.classList.add(Wi('g')),
        this.padElement.appendChild(i),
        (this.svgElem_ = i);
      const s = t.createElementNS(O, 'line');
      s.classList.add(Wi('ax')),
  ...
  function ts(t, e, n) {
    return [Re(e[0], Ie(t)), Re(e[1], Oe(t)) * (n ? 1 : -1)];
  }
  class es {
    constructor(t, e) {
    ...
    handlePointerEvent_(t, e) {
      ...
      const n = this.maxValue_,
        i = Te(t.point.x, 0, t.bounds.width, -n, +n),
        s = Te(
      ...
      this.value.setRawValue(new Yi(i, s), e);
    }
    onPointerDown_(t) {
      this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
    }
    ...
    onPadKeyDown_(t) {
      Ke(t.key) && t.preventDefault();
      const [e, n] = ts(t, this.baseSteps_, this.invertsY_);
      (0 === e && 0 === n) ||
        this.value.setRawValue(
          new Yi(this.value.rawValue.x + e, this.value.rawValue.y + n),
          { forceEmit: !1, last: !1 }
        );
    }
    onPadKeyUp_(t) {
  ...
  function is(t) {
    return Yi.isObject(t) ? new Yi(t.x, t.y) : new Yi();
  }
  function ss(t, e) {
  ...
  function rs(t, e) {
    ...
    if (s)
      return Math.max(
        Math.abs(null !== (n = s.minValue) && void 0 !== n ? n : 0),
        Math.abs(null !== (i = s.maxValue) && void 0 !== i ? i : 0)
      );
    const o = ln(t);
    return Math.max(10 * Math.abs(o), 10 * Math.abs(e));
  }
  function as(t, e) {
    const n = e instanceof Ti ? e.components[0] : void 0,
      i = e instanceof Ti ? e.components[1] : void 0,
      s = rs(n, t.x),
      o = rs(i, t.y);
    return Math.max(s, o);
  }
  ...
  const ds = {
      ...
      constraint: (t) => {
        return (
          ...
          new Ti({
            assembly: Xi,
            components: [
              os('x' in e ? e.x : void 0, n.x),
              os('y' in e ? e.y : void 0, n.y),
            ],
          })
        );
        var e, n;
    ...
    controller: (t) => {
      const e = t.document,
        n = t.value,
        i = t.constraint;
      if (!(i instanceof Ti)) throw d.shouldNeverHappen();
      const s = 'expanded' in t.params ? t.params.expanded : void 0,
        o = 'picker' in t.params ? t.params.picker : void 0;
      return new ns(e, {
        axes: [
          ls(n.rawValue.x, i.components[0]),
          ls(n.rawValue.y, i.components[1]),
        ],
        expanded: null != s && s,
        invertsY: ps(t.params),
        maxValue: as(n.rawValue, i),
        parser: Ce,
  ...
  const hs = {
    toComponents: (t) => t.getComponents(),
    fromComponents: (t) => new cs(...t),
  };
  function us(t) {
    return cs.isObject(t) ? new cs(t.x, t.y, t.z) : new cs();
  }
  function vs(t, e) {
  ...
  const bs = {
    ...
    controller: (t) => {
      const e = t.value,
        n = t.constraint;
      if (!(n instanceof Ti)) throw d.shouldNeverHappen();
      return new $i(t.document, {
        assembly: hs,
        axes: [
          ms(e.rawValue.x, n.components[0]),
          ms(e.rawValue.y, n.components[1]),
          ms(e.rawValue.z, n.components[2]),
        ],
        parser: Ce,
        value: e,
        viewProps: t.viewProps,
  ...
  const gs = {
    toComponents: (t) => t.getComponents(),
    fromComponents: (t) => new _s(...t),
  };
  function fs(t) {
    return _s.isObject(t) ? new _s(t.x, t.y, t.z, t.w) : new _s();
  }
  function ws(t, e) {
    t.writeProperty('x', e.x),
      t.writeProperty('y', e.y),
      ...
      return new $i(t.document, {
        ...
        axes: e.rawValue.getComponents().map((t, e) => {
          return (
            (i = t),
            {
              baseStep: ln((s = n.components[e])),
              constraint: s,
              textProps: V.fromObject({
                draggingScale: pn(s, i),
                formatter: ke(an(s, i)),
              }),
            }
          );
  ...
  const Cs = {
      ...
      controller: (t) => {
        ...
        return s && Ht(s, zt)
          ...
          : new ne(n, {
              parser: (t) => t,
              props: V.fromObject({ formatter: Me }),
              value: i,
              viewProps: t.viewProps,
            });
      },
    },
    ys = { defaultInterval: 200, defaultLineCount: 3 },
    Ps = m('mll');
  class ks {
    constructor(t, e) {
  ...
  const Ss = {
      ...
      accept: (t, e) => {
        if ('boolean' != typeof t) return null;
        const n = A(e, { lineCount: S.optional.number });
        return n ? { initialValue: t, params: n } : null;
      },
      binding: { reader: (t) => ie },
      controller: (t) => {
  ...
  class Ds {
    ...
    update_() {
      ...
      this.value.rawValue.forEach((o, r) => {
        if (void 0 === o) return;
        const a = Te(r, 0, e, 0, t.width),
          l = Te(o, n, i, t.height, 0);
        s.push([a, l].join(','));
      }),
        this.lineElem_.setAttributeNS(null, 'points', s.join(' '));
      const o = this.tooltipElem_,
        r = this.value.rawValue[this.cursor_.rawValue];
      if (void 0 === r) return void o.classList.remove(As('t', 'a'));
      const a = Te(this.cursor_.rawValue, 0, e, 0, t.width),
        l = Te(r, n, i, t.height, 0);
      (o.style.left = `${a}px`),
        (o.style.top = `${l}px`),
        (o.textContent = `${this.formatter_(r)}`),
        o.classList.contains(As('t', 'a')) ||
          (o.classList.add(As('t', 'a'), As('t', 'in')),
          I(o),
          o.classList.remove(As('t', 'in')));
    }
    onValueUpdate_() {
      this.update_();
    }
  ...
  class js {
    ...
    onGraphMouseMove_(t) {
      ...
      this.cursor_.rawValue = Math.floor(
        Te(t.offsetX, 0, e.width, 0, this.value.rawValue.length)
      );
    }
  ...
  function Rs(t) {
    return 'format' in t && !a(t.format) ? t.format : ke(2);
  }
  function Os(t) {
  ...
  const Is = {
      ...
      controller: (t) =>
        Os(t.params)
          ? (function (t) {
              var e, n, i;
              return new js(t.document, {
                formatter: Rs(t.params),
                lineCount:
                  null !== (e = t.params.lineCount) && void 0 !== e
                    ? e
                    : ys.defaultLineCount,
  ...
  function Ts(t, e) {
    return 0 === e ? new Bt() : new Ft(t, null != e ? e : ys.defaultInterval);
  }
  class Bs {
    constructor() {
    ...
    createInput(t, e, n) {
      if (a(e.read()))
        throw new d({ context: { key: e.key }, type: 'nomatchingcontroller' });
            ...
            : (function (t, e) {
                ...
                const i = S,
                  ...
                  h = t.controller({
                    ...
                    params: n.params,
                    value: p.value,
                    viewProps: Mt.create({ disabled: d, hidden: c }),
                  }),
                  u = i.optional.string(e.params.label).value;
                return new it(e.document, {
                  binding: p,
                  blade: Q(),
                  props: V.fromObject({ label: null != u ? u : e.target.key }),
                  valueController: h,
                });
            ...
            : (function (t, e) {
                ...
                const l = {
                  ...
                  m = t.controller({
                    ...
                    params: r.params,
                    value: h.value,
                    viewProps: Mt.create({ disabled: u, hidden: v }),
                  }),
                  b =
        ...
        (n, i) =>
          null != n
            ...
            : (function (t, e) {
                ...
                if (!n) return null;
                const i = S.optional.boolean(e.params.disabled).value,
                  s = S.optional.boolean(e.params.hidden).value;
                return t.controller({
                  blade: Q(),
                  document: e.document,
                  ...
                  viewProps: Mt.create({ disabled: i, hidden: s }),
                });
              })(i, { document: t, params: e }),
        null
      );
      if (!n) throw new d({ type: 'nomatchingview', context: { params: e } });
      return n;
    }
    createBladeApi(t) {
      if (t instanceof it) return new nt(t);
      if (t instanceof ot) return new st(t);
      if (t instanceof bt) return new pt(t, this);
  ...
  const zs = {
    ...
    controller(t) {
      const e = new Qt(t.document, {
        props: V.fromObject({ options: sn(t.params.options) }),
    ...
    api: (t) =>
      t.controller instanceof xt && t.controller.valueController instanceof Qt
        ? new Fs(t.controller)
        : null,
  };
  class qs extends dt {
    ...
    refresh() {
      this.controller_.rackController.rack.find(it).forEach((t) => {
        t.binding.read();
      }),
        this.controller_.rackController.rack.find(ot).forEach((t) => {
          t.binding.read();
        });
    }
  }
  ...
  const Ys = {
      ...
      controller(t) {
        ...
        const i = null !== (e = t.params.value) && void 0 !== e ? e : 0,
          s = new We(t.document, {
            baseStep: 1,
            parser: Ce,
            sliderProps: V.fromObject({
              maxValue: t.params.max,
              minValue: t.params.min,
            }),
            textProps: V.fromObject({
              draggingScale: pn(void 0, i),
              formatter:
                null !== (n = t.params.format) && void 0 !== n ? n : Pe,
            }),
            value: E(i),
            viewProps: t.viewProps,
          });
      ...
      api: (t) =>
        t.controller instanceof xt && t.controller.valueController instanceof We
          ? new $s(t.controller)
          : null,
    },
    Xs = {
      ...
      api: (t) =>
        t.controller instanceof xt && t.controller.valueController instanceof ne
          ? new Hs(t.controller)
          : null,
    };
  function Qs(t, e, n) {
  ...
  (t.BladeApi = e),
    (t.ButtonApi = h),
    (t.FolderApi = dt),
    (t.InputBindingApi = nt),
    (t.ListApi = Fs),
    (t.MonitorBindingApi = st),
    (t.Pane = class extends qs {
      constructor(t) {
        var e, n;
        const i = null != t ? t : {},
          s = null !== (e = i.document) && void 0 !== e ? e : N(),
          o = (function () {
            const t = new Bs();
            return (
              [
      ...
      get document() {
        if (!this.doc_) throw d.alreadyDisposed();
        return this.doc_;
      }
      dispose() {
        const t = this.containerElem_;
        if (!t) throw d.alreadyDisposed();
      ...
      embedPluginStyle_(t) {
        t.css && Qs(this.document, `plugin-${t.id}`, t.css);
      }
      setUpDefaultPlugins_() {
        Qs(
          ...
          this.registerPlugin({ plugins: [Ys, zs, Tt, Xs] });
      }
    }),
    (t.SeparatorApi = Ct),
    (t.SliderApi = $s),
